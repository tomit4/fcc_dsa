public class SinglyLinkedList {
  ...
  // An example of using Floyd's Cycle Finding Algorithm
  // https://en.wikipedia.org/w/index.php?title=Cycle_detection&useskin=vector#Floyd's_tortoise_and_hare
